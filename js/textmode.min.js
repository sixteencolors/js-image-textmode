...
d)d=this.screen[a].length;return d};b.prototype.getHeight=function(){return this.screen.length};b.prototype.renderCanvas=function(d){var a,c,i,b,e,f,h,j,k,l,q,r,m,n,o,p;r=this.getWidth()*this.font.width;h=this.getHeight()*this.font.height;c=document.createElement("canvas");c.setAttribute("width",r);c.setAttribute("height",h);i=c.getContext("2d");e=0;for(m=this.screen.length-1;0<=m?e<=m:e>=m;0<=m?e+=1:e-=1)if(this.screen[e]!=null){b=0;for(n=this.screen[e].length-1;0<=n?b<=n:b>=n;0<=n?b+=1:b-=1)if(j=
this.screen[e][b],j!=null){f=j.attr&15;a=(j.attr&240)>>4;l=b*8;q=e*16;i.fillStyle=this.palette.toRgbaString(this.palette.colors[a]);i.fillRect(l,q,8,16);i.fillStyle=this.palette.toRgbaString(this.palette.colors[f]);a=this.font.chars[j.ch.charCodeAt(0)&255];f=0;for(o=this.font.height-1;0<=o?f<=o:f>=o;0<=o?f+=1:f-=1){k=a[f];j=0;for(p=this.font.width-1;0<=p?j<=p:j>=p;0<=p?j+=1:j-=1)k&1<<this.font.width-1-j&&i.fillRect(l+j,q+f,1,1)}}}d.setAttribute("width",r);d.setAttribute("height",h);i=d.getContext("2d");
return i.drawImage(c,0,0)};return b}();this.ImageTextModeXBin=function(){function b(d){var a,c;b.__super__.constructor.apply(this,arguments);this.header={width:0,height:0,fontisze:0,flags:0};for(a in d)k.call(d,a)&&(c=d[a],this[a]=c)}l(b,this.ImageTextMode);b.prototype.parse=function(d){var a,c;this.screen=[];a=d.substr(0,11);if(a.length===!1||!a.match("^XBIN\u001a"))throw Error("File is not an XBin");this.header.width=this.unpackShort(a.substr(5,2));this.header.height=this.unpackShort(a.substr(7,
2));this.header.fontsize=this.getByteAt(a.substr(9,1));this.header.flags=this.getByteAt(a.substr(10,1));c=11;this.header.flags&1&&(this._parse_palette(d.substr(c,48)),c+=48);if(this.header.flags&2)a=this.header.fontsize,a*=this.header.flags&16?512:256,this._parse_font(d.substr(c,a)),c+=a;return this.header.flags&4?this._parse_compressed(d.substr(c)):this._parse_uncompressed(d.substr(c))};b.prototype._parse_palette=function(d){var a,c,i,b,e;c=[];for(b=0;b<=45;b+=3)e=this.getByteAt(d,b),e=e<<2|e>>4,
i=this.getByteAt(d,b+1),i=i<<2|i>>4,a=this.getByteAt(d,b+2),a=a<<2|a>>4,c[b/3]=[e,i,a];return this.palette=new ImageTextModePalette({colors:c})};b.prototype._parse_font=function(d){var a,c,b,g,e,f,h;b=this.header.fontsize;a=[];g=0;for(f=d.length/b-1;0<=f?g<=f:g>=f;0<=f?g+=1:g-=1){c=[];e=0;for(h=b-1;0<=h?e<=h:e>=h;0<=h?e+=1:e-=1)c.push(this.getByteAt(d,g*b+e));a.push(c)}return this.font=new ImageTextModeFont({chars:a,height:b})};b.prototype._parse_compressed=function(d){var a,c,b,g,e,f,h,j;h=f=0;this.screen[h]=
[];d=d.split("");for(j=[];g=d.shift();){g=this.getByteAt(g,0);if(g===26)break;e=g&192;b=(g&63)+1;a=c=null;j.push(function(){for(;b-- >0;){switch(e){case 0:c=d.shift();a=d.shift();break;case 64:c==null&&(c=d.shift());a=d.shift();break;case 128:a==null&&(a=d.shift());c=d.shift();break;default:c==null&&(c=d.shift()),a==null&&(a=d.shift())}this.screen[h][f]={ch:c,attr:this.getByteAt(a,0)};f++;if(f===this.header.width){f=0;h++;if(h===this.header.height)break;this.screen[h]==null&&(this.screen[h]=[])}}return[]}.call(this))}return j};
...
[]);this.screen[this.y][this.x]={ch:b,attr:this.attr};if(++this.x>=this.linewrap)return this.x=0,this.y++};return b}.call(this);this.ImageTextModeBin=function(){function b(d){var a,c;b.__super__.constructor.apply(this,arguments);this.linewrap=160;for(a in d)k.call(d,a)&&(c=d[a],this[a]=c)}l(b,this.ImageTextMode);b.prototype.parse=function(b){var a,c,i,g,e,f,h;e=g=0;this.screen[e]=[];h=[];i=0;for(f=b.length-3;0<=f?i<=f:i>=f;i+=2){c=b.substr(i,1);if(c==="\u001a")break;a=this.getByteAt(b,i+1);this.screen[e][g]=
{ch:c,attr:a};g++;h.push(g===this.linewrap?(g=0,e++,this.screen[e]==null?this.screen[e]=[]:void 0):void 0)}return h};return b}.call(this)}).call(this);