...
[]);this.screen[this.y][this.x]={ch:b,attr:this.attr};if(++this.x>=this.linewrap)return this.x=0,this.y++};return b}.call(this);this.ImageTextModeBin=function(){function b(d){var a,c;b.__super__.constructor.apply(this,arguments);this.linewrap=160;for(a in d)k.call(d,a)&&(c=d[a],this[a]=c)}l(b,this.ImageTextMode);b.prototype.parse=function(b){var a,c,g,h,e,f,i;e=h=0;this.screen[e]=[];i=[];g=0;for(f=b.length-2;0<=f?g<=f:g>=f;g+=2){c=b.substr(g,1);if(c==="\u001a")break;a=this.getByteAt(b,g+1);this.screen[e][h]=
{ch:c,attr:a};h++;i.push(h===this.linewrap?(h=0,e++,this.screen[e]==null&&g+2<b.length&&b.substr(g+2,1)!=="\u001a"?this.screen[e]=[]:void 0):void 0)}return i};return b}.call(this);this.ImageTextModeIDF=function(){function b(d){var a,c;b.__super__.constructor.apply(this,arguments);this.header={x0:0,x1:0,y0:0,y1:0};for(a in d)k.call(d,a)&&(c=d[a],this[a]=c)}l(b,this.ImageTextMode);b.prototype.parse=function(b){var a,c,g,h,e,f,i,j;g=b.substr(0,12);if(g.length===!1||!g.match("^\u00041.4"))throw Error("File is not an IDF");
this.header.x0=this.unpackShort(g.substr(4,2));this.header.y0=this.unpackShort(g.substr(6,2));this.header.x1=this.unpackShort(g.substr(8,2));this.header.y1=this.unpackShort(g.substr(10,2));g=b.length-48-4096;b.substr(b.length-128,5)==="SAUCE"&&(g-=128);this.parseFontData(b.substr(g,4096));this.parsePaletteData(b.substr(g+4096,48));i=j=0;this.screen[j]=[];for(f=12;f<g;){a=b.substr(f,2);c=this.unpackShort(a);f+=2;e=1;c===1&&(e=this.unpackShort(b.substr(f,2))&255,f+=2,a=b.substr(f,2),f+=2);c=a.substr(0,
1);a=this.getByteAt(a,1);for(h=1;1<=e?h<=e:h>=e;1<=e?h+=1:h-=1)this.screen[j][i]={ch:c,attr:a},i++,i>this.header.x1&&(i=0,j++,this.screen[j]=[])}if(this.screen[j].length===0)return this.screen.pop()};return b}.call(this)}).call(this);